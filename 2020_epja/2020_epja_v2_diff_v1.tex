...
\title{Charge exchange
  ...
  reaction study at 1.75 A \GeVc by the STRELA spectrometer \DIFaddtex{diff-PDF of the original version}} %MUCHA
...
%DIF <  two-column wide
  %DIFDELCMD < \centering
%DIFDELCMD <   \includegraphics[width=1.00\textwidth]{STRELA_layout.pdf}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
\DIFaddend \begin{figure}[h]
  \centering
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.48\textwidth]{p1_plus_p2_1.pdf}
%DIFDELCMD <   %%%
...
\DIFdelendFL \DIFaddbeginFL \begin{figure}[t]
  \DIFaddendFL \centering
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.48\textwidth]{p1_plus_p2_2.pdf}
%DIFDELCMD <   %%%
...
\DIFdelbegin %DIFDELCMD < \begin{figure}[t]
%DIFDELCMD <   \centering
%DIFDELCMD <   \includegraphics[width=0.41\textwidth]{p1_vs_p2_1.pdf} %%%
...
\DIFdelbegin %DIFDELCMD < \begin{figure}[h]
%DIFDELCMD <   \centering
%DIFDELCMD <   \includegraphics[width=0.48\textwidth]{dp_dN.pdf}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
