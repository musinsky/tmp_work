...
\begin{figure}[t]
  ...
  \caption{Plot of the GEANT3 tracked 1m HBC two charged particles momenta
    ...
    % Plot of the GEANT3 tracked 1m HBC charged particles momenta from $dp$
    % measured momenta $p_1$ \textit{vs.} $p_2$ of the two
    % tracks from GEANT3 tracked 1m HBC $dp$
    % $dp$ reaction: (a) simulation includes all channels $dp$
    % reaction, (b) simulation only \dpfrag channel. \\
    % experiment NOVYOBRAZOK
