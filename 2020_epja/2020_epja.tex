...
spectrometer composed of scintillator detectors S1, S2
\todo[fancyline]{MUSINSKY: S1--S3 + prerobit obrazok}
...
$\times$ 7 $\times$ 0.5 cm$^3$).
\todo[inline]{MUSINSKY: doplnit popis S3}
