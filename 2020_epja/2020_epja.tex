...
% muup resp. upmu nefunguje z mathptmx
...
\begin{figure}[h]
  ...
  \caption{Differential distribution $dN/dt$ of the \dpchex reaction. Solid line
...
displayed in Fig. \ref{fig:dndt}. The obtained differential distribution $dN/dt$
of the \dpchex reaction are extrapolated to $t = 0$ by the expression \\
$dN/dt = [435.6 \pm 6.8] \cdot \exp([-440 \pm 9] \cdot t)$ \\
with ?2= 77.93/78.                                                               (9)

Extrapolation to t=0 gives:

dN/dt|t=0 = 435.6 . 6.8 .                                                                                          (10)

This value corresponds  to a value of the charge exchange differential cross section

ds/dt|t=0 = 30.56 . 0.48 mb/(GeV/c)2 .                                                                   (11)

The quoted error is  statistical only. Systematic uncertainties which affect the overall normalization of the cross-sections have been estimated to be about  4.6 \%. This uncertainty stems mainly from the deuteron flux determination. The u
ncertainty from the target thickness and the histogram bin width are comparably small.
The cross section was calculated using the  relation

                                                                                                 (12)

where  l  is  the target length;  n . the number  of H nuclei /cm3  , N0 . the number of beam triggers ; Nint . the number of interactions ; ? -  the histogram bin width. The number of triggers is corrected for the  efficiency of streamer
 chambers.

    The obtained charge exchange differential cross section on the deuteron at t=0  was compared with the available data from np ? pn reaction at the same interpolated energy from published data.      The closest energy data comes from me
asurements made at the SATURN accelerator [19,20]. Unlike to the other similar experiments, Bizard et al. [19] used quasi-monochromatic neutrons from accelerated deuteron stripping with a momentum spread of 5%.   New data about np ?pn sca
ttering at  the momenta of incident quasi monochromatic neutrons at 1.43, 2.3 and 5.20 GeV/c  have been obtained in [21].
     The values of ds/dt|t=0  of  np ? pn reaction as a function of the incident momenta is shown in Fig. 6. The individual differential cross sections are transformed into  ds/dt versus t, from Bizard et al. [19] in the region of momenta
 (1.4 . 1.95) GeV/c and extrapolated at each momentum to t=0  by fitting the expression

                                    ds/dt = a exp (bt + ct2).                                                          (13)
...
The plot of momenta $p_1$ versus $p_2$ of the two charged particles from $dp$
reaction is shown in Fig.4. From comparison Fig.4(a,c) with experimental results
Fig. 4b, it can be seen that the background from other channels of the $dp$
