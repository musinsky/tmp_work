...
\begin{figure*} % two-column wide
  \centering
  \includegraphics[width=0.95\textwidth]{STRELA_layout.pdf}
...
cm for DC1, DC2 (small chambers) and 25 $\times$ 25 cm for DC3, DC4 (big
...
the STRELA setup is in the range of $\sim$~90\,--120~$\muup$m for large (Fig. 11b)
and small (Fig. 11d) chambers, respectively. More technical details and the
