...
% najprv zmerat ucinny prirez charge exchange a az potom urcovat R
charge exchange channel using the \dpchex charge exchange reaction at 3.5 \GeVc
unpolarized deuteron momenta by the STRELA spectrometer and compare with
...
to contain:
\begin{itemize}
\item two protons with close momenta, approximately equal to the half of the
  incident deuteron beam momenta, from the charge exchange reaction \dpchex,
\item or a single proton from the charge retention \dpret channel, where the
