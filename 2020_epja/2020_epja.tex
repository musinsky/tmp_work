...
\begin{figure*}[t] % two-column wide
  ...
  % ZLE, len to takto pletie cloveka
  % v popise nie je spomenuta dp, resp. dp->ppn, resp. np->pn mozno vynechat
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.39\textwidth]{res_chambers.pdf} % original 0.48
...
% "Into the analysis" => into physical analysis alebo pre vypocet ucinneho
% prierezu \dpchex (asi mozno nechat, analyza nie je rekonstrukcia pripadov)
...
%                                                 can see (judge "hovorove")
of the charge exchange reaction are fully in the detector acceptance.

\begin{figure}[t]
  \centering
  \includegraphics[width=0.38\textwidth]{p1_vs_p2_1.pdf} % original 0.40
...
\begin{figure}[b]
  \centering
  \includegraphics[width=0.37\textwidth]{p1_plus_p2_1.pdf}    % 0.48
...
one compares with the results of simulation in % radsej nepisat dp->(pp)n
% one compares with the results of \dpchex simulation in
...
\begin{figure}[b]
  \centering
  \includegraphics[width=0.37\textwidth]{p1_plus_p2_2.pdf}    % crop 0.37
...
%       The STRELA experiment         alebo    deuterons (like as STRELA) is
...
% So, ... nie je to prilis "hovorove"             + STRELA (rozdelena)
